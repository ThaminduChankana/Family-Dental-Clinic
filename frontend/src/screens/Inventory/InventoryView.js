...
<br></br>
            ...
            <div style={{padding:"2rem" }} >
                ...
                .map((product) => (
                    <Grid item xs={12} sm={5} md={4} key={inventory.indexOf(product)} style={{ display:"inline-flex",width: "500px", borderRadius:"35px" }}>
                        <Card style={{width: "600px", height: "22rem", margin: 25, borderRadius:"35px", boxShadow:"10px 10px 5px #888888"}} key="0">
                            <Card.Header style={{borderRadius:"35px", margin:5}}>
                            ...
                            <h5 >{product.description}</h5>
                                ...
                                <Button href={`/inventory-update/${product._id}`} style={{borderRadius:"20px", paddingRight:"5px", paddingLeft:"5px", width:"70px", boxShadow:"5px 5px 2px #888888"}}>Edit</Button>
                                <Button variant="danger" className="mx-2" onClick={() => deleteHandler(product._id)} style={{borderRadius:"20px", paddingRight:"5px", paddingLeft:"5px", width:"70px", boxShadow:"5px 5px 2px #888888"}}>
                                    Delete
                                </Button>
                                </div>
                            </Card.Body>
